        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-category">Websites Content</li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="emails">
                            <ul class="nav sub-menu">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('users.trash') }}" class="nav-link">trash user</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="Category">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('new.category') }}" class="nav-link"> add new category</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#tags" role="button" aria-expanded="false"
                            aria-controls="tags">
                            <i class="link-icon" data-feather="mail"></i>
